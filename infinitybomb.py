...
---------------------------------------------------------
    ...
    if menu == 1:
        system("cls||clear")
        print(Fore.LIGHTYELLOW_EX + "+90' olmadan numarayı yazın:  "+ Fore.LIGHTGREEN_EX, end="")
        tel_no = input()
        tel_liste = []
        if tel_no == "":
            system("cls||clear")
            print(Fore.LIGHTYELLOW_EX + ""+ Fore.LIGHTGREEN_EX, end="")
            dizin = input()
            try:
        ...
        system("cls||clear")
        try:
            print(Fore.LIGHTYELLOW_EX + "Doğrulama icin entere basın"+ Fore.LIGHTGREEN_EX, end="")
            mail = input()
        ...
        system("cls||clear")
        try:
            print(Fore.LIGHTYELLOW_EX + f"Kaç adet sms göndermek istiyorsun sınırsız ise entere basın: "+ Fore.LIGHTGREEN_EX, end="")
            kere = input()
            if kere:
                kere = int(kere)
            else:
